    ...
    return (
        <div className="max-w-screen-xl mx-auto px-6 pt-32 pb-16">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
                ...
                {/* Body Text */}
                <div className="flex-1 text-neutral-300 leading-relaxed my-auto">
                    <p>
                ...
                {highlights.map((item, index) => {
                    ...
                    return (
                        <div key={index} className="flex flex-col md:flex-row gap-8 items-center">
                            <div className={`relative w-full md:w-2/5 flex-shrink-0 rounded-xl aspect-video overflow-hidden bg-neutral-800 ${!imageFirst ? 'md:order-2' : ''}`}>
                                <img
                                    src={item.images[cur]}
